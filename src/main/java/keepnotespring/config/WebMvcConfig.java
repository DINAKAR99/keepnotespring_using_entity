...
public class WebMvcConfig implements WebMvcConfigurer {
	...
	public InternalResourceViewResolver getviewResolver() {
		...
		InternalResourceViewResolver i1 = new InternalResourceViewResolver();

		i1.setPrefix("WEB-INF/views/");
		i1.setSuffix(".jsp");
	...
	@Bean("urlbased")
	public UrlBasedViewResolver geturlviViewResolver() {

		UrlBasedViewResolver i1 = new UrlBasedViewResolver();
		i1.setViewClass(JstlView.class);
		i1.setPrefix("WEB-INF/views/");
		i1.setSuffix(".jsp");
